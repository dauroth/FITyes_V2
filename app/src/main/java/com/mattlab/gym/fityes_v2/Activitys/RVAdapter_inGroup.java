...
public class RVAdapter_inGroup extends RecyclerView.Adapter<RVAdapter_inGroup.PersonViewHolder> implements View.OnClickListener {
    ...
    List<inGroupAdapter> persons;

    public RVAdapter_inGroup(List<inGroupAdapter> persons) {
